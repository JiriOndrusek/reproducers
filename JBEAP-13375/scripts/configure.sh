...
cp /home/jondruse/git/projects/mock-artifacts/ejbclient/eap7.1-httpclient-clustered-undertowlb/server/target/server.jar $EAP_HOME-node01/deployments
...
cp /home/jondruse/git/projects/mock-artifacts/ejbclient/eap7.1-httpclient-clustered-undertowlb/server/target/server.jar $EAP_HOME-node02/deployments