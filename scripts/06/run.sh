...
do
    ...
    then
        ...
        then
            ...
            ../../scripts/06/runConfiguration.sh -n=$name -t=$tmpPrefix -p=$profile -d=$debugPort -o=$offset -s='n' -b=$BACKGROUND
        else
            echo "../../scripts/04/runConfiguration.sh -n=$name -t=$tmpPrefix -p=$profile -d=$debugPort -o=$offset -s=$suspend -b=$BACKGROUND"
            ../../scripts/06/runConfiguration.sh -n=$name -t=$tmpPrefix -p=$profile -d=$debugPort -o=$offset -s=$suspend -b=$BACKGROUND
        fi
