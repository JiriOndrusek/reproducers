...
public class GoodByeBean implements GoodBye
{
   ...
   private SessionContext context;
    ...
    {
       System.out.println("*** Entering GoodBye Bean!");
       ...
       System.out.println("*** Leaving GoodBye Bean!");
       return "GoodBye " + name + "!";
    }
}
