...
public class Base64 {
   ...
   public static String encodeObject(final java.io.Serializable serializableObject, final int options) {
      ...
      try {
         ...
         b64os = new OutputStream(baos, Base64.ENCODE | options);
   ...
   public static String encodeBytes(final byte[] source, final int off, final int len, final int options) {
      ...
      if (gzip == Base64.GZIP) {
         ...
         try {
            ...
            logger.warning("Unable to encode byte array into Base64 notation" + e.getMessage());
            return null;
         } finally {
            try {
               gzos.close();
   ...
   public static Object decodeToObject(final String encodedObject) {
      ...
      try {
         ...
         logger.warning("Unable to deserialize object" +e.getMessage());
         obj = null;
      } finally {
         try {
            bais.close();
   ...
   public static boolean encodeFileToFile(final String infile, final String outfile) {
      ...
      try {
         in = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(infile)), Base64.ENCODE);
   ...
   public static boolean decodeFileToFile(final String infile, final String outfile) {
      ...
      java.io.OutputStream out = null;
      try {
         in = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(infile)), Base64.DECODE);
         out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
         byte[] buffer = new byte[65536]; // 64K
         int read = -1;
         while ((read = in.read(buffer)) >= 0) {
