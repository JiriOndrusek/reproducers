...
public class ClientSender {
    private static final Logger log = Logger.getLogger(ClientSender.class.getName());
    ...
    public static final String DEFAULT_MESSAGE_COUNT = "4";
...
//                        message.writeInt(j);
                        ...
                        System.out.println("Sent "+(j+1)+"/"+(i+1) + ", id=" + message.getJMSMessageID());
                    }

                    session.commit();
                    log.info("CLIENT01: <><><><><><<><>><> commited <><><><><><><><><>");
                }
